                        ...
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    <input type="number"
                                        class="form-control form-control-user @error('DNI') is-invalid @enderror" id="DNI"
                                        placeholder="DNI number" name="DNI" value="{{ old('DNI') }}" required
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text"
                                            ...
                                            id="first_name" placeholder="Last Name" name="last_name"
